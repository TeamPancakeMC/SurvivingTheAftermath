...
public class ModCapability{
    ...
    public static final Capability<StageCap> STAGE_CAP = CapabilityManager.get(new CapabilityToken<>() {});
    @SubscribeEvent
    public static void registerCapabilities(RegisterCapabilitiesEvent event) {
        event.register(AftermathCap.class);
        event.register(StageCap.class);
    }
    ...
    public static void attachLevelCapability(AttachCapabilitiesEvent<Level> event) {
        ...
        event.addCapability(SurvivingTheAftermath.asResource("stage_cap"), new StageCap.Provider());
    }
